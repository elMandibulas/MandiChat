...
public final class FragmentMatchesBinding implements ViewBinding {
  ...
  private FragmentMatchesBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView rvMatches) {
  ...
  public static FragmentMatchesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMatchesBinding((LinearLayout) rootView, rvMatches);
    }
